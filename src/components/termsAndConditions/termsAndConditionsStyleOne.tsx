...
interface TermsAndConditionsStyleOneProps { text: string, sectionSpace: string }

function TermsAndConditionsStyleOne({ sectionSpace, text }: TermsAndConditionsStyleOneProps) {
