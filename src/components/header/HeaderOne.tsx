...
const HeaderStyleOne = function ({ SetToggleClassName, toggleClassNameInBody, navPositionClass, topbar }
  : { SetToggleClassName: (value: boolean) => void, toggleClassNameInBody?: () => void, navPositionClass?: string, topbar?: boolean }) {
