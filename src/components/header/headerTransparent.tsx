...
interface HeaderTransparentProps { SetToggleClassName: (state: boolean) => void, topbar: boolean }

const HeaderTransparent = function ({ SetToggleClassName, topbar }: HeaderTransparentProps) {
  ...
  useEffect(() => {
    const header: any = document.querySelector(".ltn__header-sticky");
  ...
  return (
    <>
      <header className="ltn__header-area ltn__header-5 ltn__header-logo-and-mobile-menu-in-mobile ltn__header-logo-and-mobile-menu ltn__header-transparent gradient-color-2" dir="rtl">
              ...
              <Col>
                <div className="site-logo-wrap">
                  <div className="site-logo">
                    <Link href="/">
                      <img src="/img/logo.png" alt="Logo" style={{ width: "auto", objectFit: "contain", height: "5rem" }} />
                    </Link>
                  </div>
                </div>
              </Col>
